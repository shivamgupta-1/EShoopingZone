...
import com.eshoppingzone.order.orders.repository.AddressRepository;
import com.eshoppingzone.order.orders.repository.OrderRepository;
...
public class OrderServiceImpl implements OrderService {
	...
	public void placeOrder(Cart cart,String mode,String fullName) {
		...
		orderRepository.save(order);
		 ...
		 restTemplate.delete("http://cart-service/cart/delete/"+cart.getCartId());
